...
fun informarNome(jogador1: String, jogador2: String):String {
    when {
        ...
        jogador1 == "pedra" && jogador2 == "lagarto" -> return ("Jogador 1 venceu")
        jogador1 == "lagarto" && jogador2 == "spock" -> return ("Jogador 1 venceu")
        jogador1 == "spock" && jogador2 == "tesoura" -> return ("Jogador 1 venceu")
        jogador1 == "tesoura" && jogador2 == "lagarto" -> return ("Jogador 1 venceu")
        jogador1 == "lagarto" && jogador2 == "papel" -> return ("Jogador 1 venceu")
        jogador1 == "papel" && jogador2 == "spock" -> return ("Jogador 1 venceu")
        jogador1 == "spock" && jogador2 == "pedra" -> return ("Jogador 1 venceu")
